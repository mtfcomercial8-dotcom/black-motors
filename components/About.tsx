                 ...
                 <div className="flex flex-col md:flex-row gap-16 items-center">
                     <div className="w-full md:w-1/2" ref={elementRef}>
                         <h2 className={`text-4xl md:text-6xl font-display font-bold text-white mb-8 uppercase leading-tight transition-all duration-700 ${isVisible ? 'translate-x-0 opacity-100' : '-translate-x-20 opacity-0'}`}>
                             ...
                             <span className="text-brand-gold">Realizamos Sonhos.</span>
                         </h2>
                     ...
                     <div className="w-full md:w-1/2 relative">
                         <div className="relative z-10 border border-white/10 bg-white/5 p-2 backdrop-blur-sm">
                             <img src="https://images.unsplash.com/photo-1552519507-da3b142c6e3d?q=80&w=2070&auto=format&fit=crop" alt="Showroom" className="w-full h-auto" />
                         </div>
                         {/* Decorative squares */}
                         <div className="absolute -top-4 -right-4 w-24 h-24 border-t-2 border-r-2 border-brand-gold z-0"></div>
                         <div className="absolute -bottom-4 -left-4 w-24 h-24 border-b-2 border-l-2 border-brand-gold z-0"></div>
                     </div>
                 </div>
             </div>
        </section>
